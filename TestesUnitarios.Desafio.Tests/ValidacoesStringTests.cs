...
public class ValidacoesStringTests
{
    ...
    [Fact]
    public void DeveRetornar6QuantidadeCaracteresDaPalavraVivian()
    {
    ...
    {
        // Arrange
        var texto = "Esse é um texto maravilhoso";
        var textoProcurado = "maravilhoso";
    ...
    [Fact]
    public void NaoDeveConterAPalavraUrubuNoTexto()
    {
        // Arrange
        var texto = "Esse é um texto qualquer";
        var textoProcurado = "urubu";
